    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 354.0, middle: 0.5),
            Pin(size: 340.0, end: 96.0),
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.fromLTRB(0.0, 0.0, 24.0, -304.0),
                      child: SingleChildScrollView(
                        primary: false,
                        child: Wrap(
          ...
          Align(
            alignment: Alignment(0.004, -0.044),
            child: SizedBox(
              width: 139.0,
              height: 28.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.677, -0.043),
            child: Container(
              width: 28.0,
              height: 27.0,
              decoration: BoxDecoration(
