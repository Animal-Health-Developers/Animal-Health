...
class _EmergenciasState extends State<Emergencias> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          //Barra de busqueda (no necesita Tooltip para el icono de lupa, ya es obvio)
          Pinned.fromPins(
              ...
              child: Row(
                children: [
                  Padding(
                    ...
                    // Opcional: podrías poner un Tooltip aquí si el icono de lupa fuera un botón sin texto
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                // Botón de emergencias (resaltado, no es un PageLink aquí directamente)
          ...
          //BOTONES DE EMERGENCIAS (ya tenían Tooltips de la vez anterior)
          Positioned(
  ...
  Widget _buildEmergencyButton({
    ...
    return Tooltip( // <--- Agregamos el Tooltip aquí (ya estaba de la vez anterior)
      message: label, // El mensaje del tooltip será el label del botón
      child: PageLink(
        links: [
          PageLinkInfo(
            transition: LinkTransition.Fade,
