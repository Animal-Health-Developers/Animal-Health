...
class EditaroActulizarMetododepago extends StatelessWidget {
  const EditaroActulizarMetododepago({
    required Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.301, -0.309),
            child: SizedBox(
              width: 0.0,
              height: 0.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.301, -0.128),
            child: SizedBox(
              width: 0.0,
              height: 0.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.301, 0.054),
            child: SizedBox(
              width: 0.0,
              height: 0.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.066, 0.235),
            child: SizedBox(
              width: 0.0,
              height: 0.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.066, 0.417),
            child: SizedBox(
              width: 0.0,
              height: 0.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.005, 0.644),
            child: SizedBox(
              width: 223.0,
              height: 28.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(start: 37.0, end: 34.0),
            Pin(size: 47.0, middle: 0.5349),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xffffffff),
                borderRadius: BorderRadius.circular(10.0),
          ...
          Align(
            alignment: Alignment(0.005, 0.069),
            child: SizedBox(
              width: 217.0,
              height: 28.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.006, 0.444),
            child: SizedBox(
              width: 239.0,
              height: 28.0,
              child: Text(
