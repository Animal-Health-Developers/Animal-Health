...
class EditarPerfildeAnimalesdeCompaia extends StatelessWidget {
  const EditarPerfildeAnimalesdeCompaia({
    required Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 62.7, start: 9.1),
            Pin(size: 70.0, middle: 0.2068),
            child: PageLink(
              links: [
                PageLinkInfo(
                  duration: 0.3,
