        ...
        children: <Widget>[
          ...
          if (currentUserAuth != null)
            Pinned.fromPins(
              ...
              Pin(size: 60.0, middle: 0.1947), // Ajustar posición si es necesario
                      ...
                      children: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => SolucionAEMERGENCIAS(key: const Key('SolucionAEMERGENCIAS_Fracturas'), descripcionDelProblema: '',)),
                            );
                          },
