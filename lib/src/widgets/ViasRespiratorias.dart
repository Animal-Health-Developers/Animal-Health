...
class ViasRespiratorias extends StatefulWidget {
  ...
  @override
  _ViasRespiratoriasState createState() => _ViasRespiratoriasState();
}

class _ViasRespiratoriasState extends State<ViasRespiratorias> {
  // Para Vías Respiratorias, un solo campo de descripción general podría ser suficiente,
  // o podrías detallar más si es necesario (ej. tipo de tos, frecuencia, etc.)
    ...
    final Animal? animalEscogido = await Navigator.push<Animal?>(
      ...
      MaterialPageRoute(
        builder: (context) => const ListadeAnimales(
          key: Key('seleccionAnimalParaViasResp'),
  ...
  Future<void> _guardarProblemaRespiratorio() async {
    ...
    if (_descripcionSintomasController.text.trim().isEmpty) {
      _mostrarSnackbar(
          "Por favor, describe los síntomas del problema respiratorio.", Colors.orange);
      return;
    }

    try {
      final problemaRespData = {
      ...
      await FirebaseFirestore.instance
          ...
          .collection('registros_problemas_respiratorios') // Nueva subcolección
          .add(problemaRespData);

      _mostrarSnackbar(
          "Registro de problema respiratorio para ${_animalSeleccionado!.nombre} guardado con éxito.",
          Colors.green);
                      ...
                      child: ClipRRect(
                        ...
                        child: profilePhotoUrl != null && profilePhotoUrl.isNotEmpty
                            ...
                            errorWidget: (context, url, error) {
                              print("Error cargando foto de perfil del usuario (ViasResp): $error");
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        Image.asset('assets/images/vias respiratorias.png', width: 45.0, height: 45.0),
                        const SizedBox(width: 10),
                        const Text(
                          'PROBLEMA RESPIRATORIO',
                          style: TextStyle(fontFamily: 'Comic Sans MS', fontSize: 18, color: Color(0xff000000), fontWeight: FontWeight.w700), // Ajustado tamaño de fuente
                        ),
                      ],
                    ),
                    ...
                    const SizedBox(height: 20.0),
                    const Text(
                      'DESCRIPCIÓN DE SÍNTOMAS RESPIRATORIOS:',
                    ...
                    TextField(
                      ...
                      maxLines: 5, // Ajustado para más espacio
                      decoration: InputDecoration(
                        hintText: 'Describe los síntomas: tos (seca, húmeda, con flema), estornudos, secreción nasal (color, consistencia), dificultad para respirar (rápida, superficial, con ruido), cianosis (encías/lengua azulada), letargo, pérdida de apetito...',
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ElevatedButton(
                          ...
                          onPressed: _guardarProblemaRespiratorio,
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => SolucionAEMERGENCIAS(key: const Key('SolucionAEMERGENCIAS_ViasResp'), descripcionDelProblema: '',)),
                            );
                          },
