...
// import 'dart:ui' as ui; // No se usa directamente si no hay BackdropFilter complejo

class Atragantamiento extends StatefulWidget {
...
class _AtragantamientoState extends State<Atragantamiento> {
  final TextEditingController _queIngirioController = TextEditingController();
    ...
    final Animal? animalEscogido = await Navigator.push<Animal?>(
      ...
      MaterialPageRoute(
        builder: (context) => const ListadeAnimales(
          key: Key('seleccionAnimalParaAtragantamiento'),
  ...
  Future<void> _guardarAtragantamiento() async {
    ...
    if (_queIngirioController.text.trim().isEmpty ||
        _sintomasController.text.trim().isEmpty) {
      _mostrarSnackbar(
          "Por favor, completa todos los campos sobre el atragantamiento.", Colors.orange);
      return;
    }

    try {
      final atragantamientoData = {
        'queIngirio': _queIngirioController.text.trim(),
      ...
      await FirebaseFirestore.instance
          .collection('users')
          .doc(user.uid)
          .collection('animals') // Usamos 'animals' como en ListadeAnimales
          .doc(_animalSeleccionado!.id)
          .collection('registros_atragantamientos') // Nueva subcolección
          .add(atragantamientoData);

      _mostrarSnackbar(
          "Registro de atragantamiento para ${_animalSeleccionado!.nombre} guardado con éxito.",
          Colors.green);
      _queIngirioController.clear();
  ...
  Widget build(BuildContext context) {
    ...
    final User? currentUserAuth = FirebaseAuth.instance.currentUser; // Para la foto de perfil
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 45.0, start: 150.0), // Posición de la barra de búsqueda
            child: Container(
              decoration: BoxDecoration(
          ...
          if (currentUserAuth != null) // Solo mostrar si el usuario está logueado
            Pinned.fromPins(
              Pin(size: 60.0, start: 6.0), // Ajustado desde el original 13.0
              Pin(size: 60.0, middle: 0.1947), // Ajustado desde el original
                      ...
                      child: ClipRRect(
                        ...
                        child: profilePhotoUrl != null && profilePhotoUrl.isNotEmpty
                            ...
                            errorWidget: (context, url, error) {
                              print("Error cargando foto de perfil del usuario (Atragantamiento): $error");
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xcc54d1e0), // Color base del contenedor, ajustado
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        Image.asset('assets/images/atragantamiento.png', width: 45.0, height: 45.0),
                    ...
                    TextField(
                      ...
                      maxLines: 4,
                      decoration: InputDecoration(
                        hintText: 'Describe los síntomas: tos, dificultad para respirar, babeo excesivo, patas en la boca, cianosis (encías azules)...',
                        hintStyle: TextStyle(fontFamily: 'Comic Sans MS', fontSize: 15, color: Colors.grey.shade700),
                        filled: true,
                        fillColor: Colors.white.withOpacity(0.9),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: const BorderSide(color: Color(0xff707070))),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ElevatedButton(
                          ...
                          onPressed: _guardarAtragantamiento,
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => SolucionAEMERGENCIAS(key: const Key('SolucionAEMERGENCIAS_Atragantamiento'), descripcionDelProblema: '',)),
                            );
                          },
