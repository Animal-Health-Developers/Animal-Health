      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 45.0, start: 135.0), // Posición de la barra de búsqueda
            child: Container(
              decoration: BoxDecoration(
          ...
          if (currentUserAuth != null) // Solo mostrar si el usuario está logueado
            Pinned.fromPins(
              ...
              Pin(size: 60.0, start: 115.0), // Ajustado desde el original
                      ...
                      children: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => SolucionAEMERGENCIAS(key: const Key('SolucionAEMERGENCIAS_Atragantamiento'))),
                            );
                          },
