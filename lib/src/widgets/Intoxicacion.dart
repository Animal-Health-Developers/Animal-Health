    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 178.0, start: 23.0),
                  Pin(size: 24.0, middle: 0.2566),
                  child: Text(
                    'COMPORTAMIENTO:',
                    style: TextStyle(
                      fontFamily: 'Comic Sans MS',
          ...
          Align(
            alignment: Alignment(0.569, 0.636),
            child: SizedBox(
              width: 64.0,
              height: 24.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.515, 0.636),
            child: SizedBox(
              width: 49.0,
              height: 24.0,
              child: Text(
