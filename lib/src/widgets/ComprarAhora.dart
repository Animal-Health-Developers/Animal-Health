    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.017, 0.479),
            child: SizedBox(
              width: 178.0,
              height: 28.0,
              child: Text(
