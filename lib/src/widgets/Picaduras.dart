...
class Picaduras extends StatefulWidget {
  ...
  @override
  _PicadurasState createState() => _PicadurasState();
}

class _PicadurasState extends State<Picaduras> {
  final TextEditingController _tipoPicaduraController = TextEditingController();
  ...
  @override
  void dispose() {
    _tipoPicaduraController.dispose();
    ...
    final Animal? animalEscogido = await Navigator.push<Animal?>(
      ...
      MaterialPageRoute(
        builder: (context) => const ListadeAnimales(
          key: Key('seleccionAnimalParaPicadura'),
  ...
  Future<void> _guardarPicadura() async {
    ...
    if (_tipoPicaduraController.text.trim().isEmpty ||
        _descripcionSintomasController.text.trim().isEmpty) {
      _mostrarSnackbar(
          "Por favor, completa todos los campos sobre la picadura.", Colors.orange);
      return;
    }

    try {
      final picaduraData = {
        'tipoPicadura': _tipoPicaduraController.text.trim(), // Qué insecto o animal picó/mordió
      ...
      await FirebaseFirestore.instance
          ...
          .collection('registros_picaduras') // Nueva subcolección
          .add(picaduraData);

      _mostrarSnackbar(
          "Registro de picadura para ${_animalSeleccionado!.nombre} guardado con éxito.",
          Colors.green);
      _tipoPicaduraController.clear();
                      ...
                      child: ClipRRect(
                        ...
                        child: profilePhotoUrl != null && profilePhotoUrl.isNotEmpty
                            ...
                            errorWidget: (context, url, error) {
                              print("Error cargando foto de perfil del usuario (Picaduras): $error");
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        Image.asset('assets/images/picadura.png', width: 45.0, height: 45.0),
                    ...
                    const SizedBox(height: 20.0),
                    const Text(
                      'TIPO DE PICADURA (INSECTO/ANIMAL):',
                      style: TextStyle(fontFamily: 'Comic Sans MS', fontSize: 17, color: Color(0xff000000), fontWeight: FontWeight.w700),
                    ),
                    const SizedBox(height: 8.0),
                    TextField(
                      controller: _tipoPicaduraController,
                      decoration: InputDecoration(
                        hintText: 'Ej: Abeja, avispa, araña, serpiente, garrapata...',
                    ...
                    TextField(
                      ...
                      maxLines: 4,
                      decoration: InputDecoration(
                        hintText: 'Describe la zona afectada, si hay hinchazón, enrojecimiento, dolor, picor, si el animal se rasca o muerde la zona, dificultad para respirar, vómitos, debilidad...',
                        hintStyle: TextStyle(fontFamily: 'Comic Sans MS', fontSize: 15, color: Colors.grey.shade700),
                        filled: true,
                        fillColor: Colors.white.withOpacity(0.9),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: const BorderSide(color: Color(0xff707070))),
