    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.566, 0.634),
            child: SizedBox(
              width: 64.0,
              height: 24.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.518, 0.634),
            child: SizedBox(
              width: 49.0,
              height: 24.0,
              child: Text(
