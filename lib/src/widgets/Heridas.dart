...
class Heridas extends StatefulWidget {
  ...
  @override
  _HeridasState createState() => _HeridasState();
}

class _HeridasState extends State<Heridas> {
    ...
    final Animal? animalEscogido = await Navigator.push<Animal?>(
      ...
      MaterialPageRoute(
        builder: (context) => const ListadeAnimales(
          key: Key('seleccionAnimalParaHerida'),
  ...
  Future<void> _guardarHerida() async {
    ...
    if (_tipoHeridaController.text.trim().isEmpty ||
      ...
      _mostrarSnackbar(
          "Por favor, completa todos los campos sobre la herida.", Colors.orange);
      return;
    }
    ...
    try {
      ...
      await FirebaseFirestore.instance
          ...
          .collection('registros_heridas') // Nueva subcolección
          .add(heridaData);

      _mostrarSnackbar(
          "Registro de herida para ${_animalSeleccionado!.nombre} guardado con éxito.",
          Colors.green);
      _tipoHeridaController.clear();
        ...
        children: <Widget>[
                      ...
                      child: ClipRRect(
                        ...
                        child: profilePhotoUrl != null && profilePhotoUrl.isNotEmpty
                            ...
                            errorWidget: (context, url, error) {
                              print("Error cargando foto de perfil del usuario (Heridas): $error");
          ...
          Pinned.fromPins(
            ...
            child: PageLink(
              ...
              child: Container(decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/settingsbutton.png'), fit: BoxFit.fill))), // Corregido path
            ),
          ),
          Pinned.fromPins(
            ...
            child: PageLink(
              ...
              child: Container(decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/listaanimales.png'), fit: BoxFit.fill))), // Corregido path
            ),
          ),
          Pinned.fromPins(
            ...
            child: PageLink(
              ...
              child: Container(decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/store.png'), fit: BoxFit.fill))), // Corregido path
            ),
          ),
          Positioned(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        Image.asset('assets/images/heridas.png', width: 45.0, height: 45.0),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Ej: Corte, rasguño, punción, mordedura, quemadura...',
                    ...
                    TextField(
                      ...
                      maxLines: 4,
                      decoration: InputDecoration(
                        hintText: 'Describe cómo ocurrió, el lugar del cuerpo, si hay sangrado (cantidad), hinchazón, pus, mal olor, si el animal se lame excesivamente la zona...',
                        hintStyle: TextStyle(fontFamily: 'Comic Sans MS', fontSize: 15, color: Colors.grey.shade700),
                        filled: true,
                        fillColor: Colors.white.withOpacity(0.9),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: const BorderSide(color: Color(0xff707070))),
                      ...
                      children: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => SolucionAEMERGENCIAS(key: const Key('SolucionAEMERGENCIAS_Heridas'), descripcionDelProblema: '',)),
                            );
                          },
