    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.426, -0.522),
            child: SizedBox(
              width: 102.0,
              height: 42.0,
              child: Text(
            ...
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, -638.0),
                      child: SingleChildScrollView(
                        primary: false,
                        child: Wrap(
                            ...
                            return SizedBox(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Align(
                                    alignment: Alignment(-0.23, 0.619),
                                    child: SizedBox(
                                      width: 26.0,
                                      height: 28.0,
                                      child: Text(
...
const String _svg_h3fdaz =
    '<svg viewBox="4.0 185.0 404.0 600.0" ><path transform="translate(4.0, 185.0)" d="M 20 0 L 384 0 C 395.0456848144531 0 404 8.954304695129395 404 20 L 404 580 C 404 591.0457153320312 395.0456848144531 600 384 600 L 20 600 C 8.954304695129395 600 0 591.0457153320312 0 580 L 0 20 C 0 8.954304695129395 8.954304695129395 0 20 0 Z" fill="#54d1e0" fill-opacity="0.53" stroke="#000000" stroke-width="1" stroke-opacity="0.53" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
